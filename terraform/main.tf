# Terraform Configuration for AWS Deployment (Alternative to Vercel)
# This is for enterprise-grade AWS infrastructure deployment
# Use this only if you choose AWS over Vercel
